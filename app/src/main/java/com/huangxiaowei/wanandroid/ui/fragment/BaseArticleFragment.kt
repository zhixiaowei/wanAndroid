...
import com.huangxiaowei.baselib.ui.view.SuperListView
import com.huangxiaowei.wanandroid.R
import com.huangxiaowei.baselib.utils.ConnectUtils
import com.huangxiaowei.baselib.utils.ViewUtils
import kotlinx.android.synthetic.main.include_article_list.*

abstract class BaseArticleFragment: BaseFragment() {

    var articleCurPage = 0//分页
    private var adapter:BaseAdapter? = null

    override fun onCreated(view: View, savedInstanceState: Bundle?) {

        articleList.setOnSlideListener(object:
            SuperListView.IOnSlideListener {
            override fun onUp() {
                //上滑时，可能是想回到顶部，显示悬浮窗
        ...
        articleRefresh.setOnRefreshListener {
            if (ConnectUtils.isNetworkConnected(attackActivity)){
                onUpdateArticle(0)
            }else{
                onStopRequestUI()
