package com.huangxiaowei.wanandroid.utils
...
object Logger{
    ...
    fun save(msg: String,tag: String = Thread.currentThread().stackTrace[2].className){

    }

    fun saveException(msg: String,e:Exception,tag: String = Thread.currentThread().stackTrace[2].className){
        //获取详细的异常信息
        //获取行数及类名及包名
    }
